...
def main():
    ...
    print("3. Проверьте файл debug/berserker/berserker_debug.log для детального лога")
    print("4. После игры запустите: python debug/berserker/generate_berserker_report.py")
